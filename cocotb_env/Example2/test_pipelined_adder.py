...
def save_log_t1(filename="pipelined_adder_test_1.txt", data_list=log_data_t1):
...
@cocotb.test()
async def pipelined_adder_test_1(dut):
    ...
    save_log_t1("pipelined_adder_test_1.txt", log_data_t1)  

    dut._log.info("pipelined_adder_test_1 Test completed.")
...
@cocotb.test()
async def pipelined_adder_test_2(dut):
    ...
    # Save data to file after the test
    save_log_t1("pipelined_adder_test_2.txt", log_data_t2)  

    dut._log.info("pipelined_adder_test_2 Test completed.")
